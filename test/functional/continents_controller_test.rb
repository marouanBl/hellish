...
class ContinentsControllerTest < ActionController::TestCase
  ...
  test "should create continent" do
    assert_difference('Continent.count') do
      post :create, continent: { created_at: @continent.created_at, name: @continent.name, updated_at: @continent.updated_at }
    end
  ...
  test "should update continent" do
    put :update, id: @continent, continent: { created_at: @continent.created_at, name: @continent.name, updated_at: @continent.updated_at }
    assert_redirected_to continent_path(assigns(:continent))
  end
